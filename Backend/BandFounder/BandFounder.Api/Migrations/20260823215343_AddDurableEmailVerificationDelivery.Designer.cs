...
namespace BandFounder.Api.Migrations
{
    ...
    [Migration("20260823215343_AddDurableEmailVerificationDelivery")]
    partial class AddDurableEmailVerificationDelivery
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BandFounder.Domain.Entities.AccountNotificationPreferences", b =>
                {
                    b.Property<Guid>("AccountId")
                        .HasColumnType("uuid");

                    b.Property<bool>("EmailOnNewMessage")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true);

                    b.Property<int>("EmailUnreadDelayMinutes")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("AccountNotificationPreferences");
                });
            ...
            modelBuilder.Entity("BandFounder.Domain.Entities.ChatroomReadState", b =>
                {
                    b.Property<Guid>("AccountId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BandFounder.Domain.Entities.EmailNotificationOutbox", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("LatestSenderName")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<int>("UnreadCountHint")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("RecipientAccountId", "ChatRoomId")
                        .IsUnique()
            ...
            modelBuilder.Entity("BandFounder.Domain.Entities.EmailVerificationToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime?>("DeliveryLastAttemptAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("DeliveryLastError")
                        .HasColumnType("text");

                    b.Property<DateTime>("DeliveryNotBeforeUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("DeliveryProcessedAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasIndex("DeliveryStatus", "DeliveryNotBeforeUtc");
            ...
            modelBuilder.Entity("BandFounder.Domain.Entities.PasswordResetToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BandFounder.Domain.Entities.AccountNotificationPreferences", b =>
                {
                    b.HasOne("BandFounder.Domain.Entities.Account", "Account")
                        ...
                        .HasForeignKey("BandFounder.Domain.Entities.AccountNotificationPreferences", "AccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BandFounder.Domain.Entities.EmailNotificationOutbox", b =>
                {
                    ...
                    b.HasOne("BandFounder.Domain.Entities.Account", "RecipientAccount")
                        .WithMany()
            ...
            modelBuilder.Entity("BandFounder.Domain.Entities.MusicianSlot", b =>
                {
                    b.HasOne("BandFounder.Domain.Entities.Account", "Assignee")
                        .WithMany("AssignedMusicianSlots")
            ...
            modelBuilder.Entity("BandFounder.Domain.Entities.Account", b =>
                {
                    b.Navigation("AssignedMusicianSlots");
